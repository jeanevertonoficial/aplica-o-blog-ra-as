...
<body>
    <main>
        <section id="section-base-lista">
            <article id="artigo-card">
                <nav class="nav-card">
                    <img class="img-card" src="../public/imagens/cachorro.jpg" width="300" alt="">
                    <label class="label-card" for="">NOME DO CACHORRO</label>
                </nav>
            </article>
            <article id="artigo-card">
                <nav class="nav-card">
